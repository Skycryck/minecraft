...
nav_overview:mcIcon('ender_eye')+' Vue globale',nav_leaderboards:mcIcon('nether_star')+' Classements',
...
chart_overview_bar_prefix:'Comparaison —',overview_metric_label:'Métrique',
...
nav_compare_btn:mcIcon('comparator')+' Comparer',nav_compare_label:'Comparer deux joueurs',
...
hm_days_active:'jours actifs',hm_no_data:'pas de snapshot',hm_snapshot_gap:'snapshot présent, pas de mesure (écart)',
...
nav_overview:mcIcon('ender_eye')+' Overview',nav_leaderboards:mcIcon('nether_star')+' Leaderboards',
...
chart_overview_bar_prefix:'Comparison —',overview_metric_label:'Metric',
...
hm_days_active:'active days',hm_no_data:'no snapshot',hm_snapshot_gap:'snapshot present, no measurement (gap)',
...
nav_compare_btn:mcIcon('comparator')+' Compare',nav_compare_label:'Compare two players',
